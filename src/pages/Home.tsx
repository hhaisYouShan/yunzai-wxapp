...
import { PlayCircle, BookOpen, Users, GraduationCap, ChevronRight, Calendar, Video, School, Briefcase } from "lucide-react";
...
const Home = () => {
  ...
  const features = [
    { icon: School, label: "学校", color: "text-primary", to: "/schools" },
    { icon: Briefcase, label: "研修班", color: "text-primary", to: "/training" },
