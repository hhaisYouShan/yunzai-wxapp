    ...
    <div className="min-h-screen bg-background pb-20">
      ...
      <div className="px-4 py-5">
        <div className="grid grid-cols-4 gap-3">
          {features.map((feature) => (
            ...
            >
              <img src={icons[feature.icon as keyof typeof icons]} alt="" className={`w-8 h-8 mx-auto mb-2`} />
          ...
          <div className="relative">
            ...
            <div className="absolute bottom-4 left-0 right-0 px-4">
              ...
              <div className="flex gap-2">
                ...
                >
                  <img src={icons.Briefcase} alt="" className="w-4 h-4 mr-2" />
                  立即加入
                </Button>
                <Button 
                  variant="outline" 
      ...
      <div className="px-4 py-3">
        <div className="flex items-center justify-between mb-4">
          ...
          >
            更多 <img src={icons.ChevronRight} alt="" className="w-4 h-4" />
          </button>
        </div>
        <Card 
            ...
            >
              <div className="relative">
                ...
                <div className="absolute inset-0 flex items-center justify-center bg-black/20">
                  <div className="w-10 h-10 bg-white/90 rounded-full flex items-center justify-center">
                    <img src={icons.PlayCircle} alt="" className="w-6 h-6" />
                  </div>
                </div>
              ...
              <div className="p-3">
                ...
                <p className="text-xs text-muted-foreground flex items-center gap-1">
                  <img src={icons.Video} alt="" className="w-3 h-3" />
                  {video.views}次观看
                </p>
              </div>
            </Card>
